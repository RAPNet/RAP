...
_C.MODEL.SEMANTIC.NUM_CLASSES = 54
_C.MODEL.SEMANTIC.LOSS_WEIGHT = 0.5
_C.MODEL.SEMANTIC.OVERLAP_THR = 0.5
_C.MODEL.SEMANTIC.CONFIDENCE_THR = 0.5
_C.MODEL.SEMANTIC.LARGE_OVERLAP_THR = 0.5
_C.MODEL.SEMANTIC.COMBINE_METHOD = "heuristic"
_C.MODEL.SEMANTIC.STUFF_AREA_LIMIT = 4096
...
# use for relation finetune
_C.SOLVER.FINETUNE = False
_C.SOLVER.FINETUNE_USE_SCORE = False
