...
from panoptic_benchmark.utils.pan_utils import get_traceback, rgb2id
...
def pq_compute(gt_json_file, pred_json_file, gt_folder=None, pred_folder=None, maskiou_on=False):
...
if __name__ == "__main__":
    ...
    pred_folder = "output_coco_panoptic_R_50/inference/coco_2017_val/pred_result"
    gt_json_file = "datasets/coco/annotations/panoptic_val2017.json"
    pred_json_file = "output_coco_panoptic_R_50/inference/coco_2017_val/panoptic_pred_val2017.json"
    
    pq_compute(gt_json_file, pred_json_file, gt_folder, pred_folder)
