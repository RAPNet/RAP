...
from panoptic_benchmark.engine.inference_ps_ocfusion import inference_ps_ocfusion
...
def main():
    ...
    save_dir = ""
    logger = setup_logger("panoptic_benchmark", save_dir, get_rank())
    ...
    for output_folder, dataset_name, data_loader_val in zip(output_folders, dataset_names, data_loaders_val):
        if cfg.MODEL.SEMANTIC.COMBINE_METHOD == "RAP" or cfg.MODEL.SEMANTIC.COMBINE_METHOD == "heuristic":
            inference_ps(
                cfg,
                model,
                data_loader_val,
